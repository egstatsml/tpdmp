"""get entropy of predictive classification distribution"""
...
from tbnn.pdmp.model import create_entropy_hist, create_entropy_hist_map
...
def main(args):
  ...
  if args.is_map:
    create_entropy_hist_map(model,
                            args.out_dir,
                            test_ds,
                            args.data,
                            data_dimension_dict['out_dim'],
                            create_reliability=args.reliability)
  # otherwise is for sampled predictive results
  else:
    create_entropy_hist(model,
                        args.out_dir,
                        test_ds,
                        args.data,
                        data_dimension_dict['out_dim'],
...
if __name__ == '__main__':
  ...
  parser.add_argument('--is_map',
                      type=bool,
                      default=False,
                      nargs='?',
                      const=True,
                      help='whether is map of network.')
  parser.add_argument('--reliability',
                      type=bool,
                      default=False,
                      nargs='?',
                      const=True,
                      help='whether to create reliability diagram')
